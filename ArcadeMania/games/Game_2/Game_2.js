...
function jatekMezokFeltoltese() {
    ...
    jatekMezoTomb.forEach(kepMezo => {
        ...
        kep.addEventListener("click", () => {
            ...
            kattintasokSzama++;
            eddigiKattintas.innerHTML = "Eddig felfordított kártyalapok száma: " + kattintasokSzama;
    ...
    fetch('get_high_score.php')
        ...
        .then(data => {
            if (data.success) {
                ...
                maxEredmeny.innerHTML = "Legjobb eredmény (legkevesebb lépés): " + max;
            } else {
                ...
                if (ujEredmeny < jelenlegiHighScore) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            maxEredmeny.innerHTML = "Legjobb eredmény (legkevesebb lépés): " + ujEredmeny;
                        } else {
