...
<div style="text-align: center; margin-top: 100px;">
    ...
    <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
        ...
        <div style="width: 200px; background-color: rgba(0, 0, 0, 0.8); border: 2px solid white; border-radius: 10px; padding: 10px; text-align: center;">
            <img src="proba.png" alt="Game 1" style="width: 100%; height: auto; border-radius: 5px;">
            <h3 style="color: white; font-size: 14px; margin: 10px 0;">Fighter</h3>
            <a href="game1.php" style="text-decoration: none;">
        ...
        <!-- Game 2 Card -->
        <div style="width: 200px; background-color: rgba(0, 0, 0, 0.8); border: 2px solid white; border-radius: 10px; padding: 10px; text-align: center;">
            <img src="card.png" alt="Game 2" style="width: 100%; height: auto; border-radius: 5px;">
            <h3 style="color: white; font-size: 14px; margin: 10px 0;">Memori</h3>
            <a href="game2.php" style="text-decoration: none;">
                <button>Play Game</button>
            </a>
        </div>
        ...
        <!-- Game 3 Card -->
        <div style="width: 200px; background-color: rgba(0, 0, 0, 0.8); border: 2px solid white; border-radius: 10px; padding: 10px; text-align: center;">
            <img src="snake.png" alt="Game 3" style="width: 100%; height: auto; border-radius: 5px;">
            <h3 style="color: white; font-size: 14px; margin: 10px 0;">Snake</h3>
            <a href="game_3.php" style="text-decoration: none;">
                <button>Play Game</button>
            </a>
        </div>
        ...
        <!-- Game 4 Card -->
        <div style="width: 200px; background-color: rgba(0, 0, 0, 0.8); border: 2px solid white; border-radius: 10px; padding: 10px; text-align: center;">
            <img src="proba.png" alt="Game 4" style="width: 100%; height: auto; border-radius: 5px;">
            <h3 style="color: white; font-size: 14px; margin: 10px 0;">Horror</h3>
            <a href="game4.php" style="text-decoration: none;">
                <button>Play Game</button>
            </a>
        </div>
    </div>
